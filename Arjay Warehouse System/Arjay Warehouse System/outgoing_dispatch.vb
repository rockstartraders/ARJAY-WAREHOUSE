...
Public Class outgoing_dispatch
    ...
    Private Sub outgoing_dispatch_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Next
        TextBox3.Text = "OUT" + "-" + "ARJ" + "-" + "0011" + password.ToString
    ...
    Private Sub Button4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button4.Click
        ...
        Dim akimariaozawa As DialogResult = MsgBox("Are You Sure You Want to Exit ?", 4 + 32, )

        If akimariaozawa = DialogResult.Yes Then
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        TextBox1.AppendText("Current Stock Prior to Releasing Stocks" + vbNewLine)
        ...
        TextBox1.AppendText("==================================================================" + vbNewLine)
        TextBox1.AppendText("Stock Release" + vbNewLine)
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        ...
        If a = DialogResult.Yes Then
            ...
            rd = cmd.ExecuteReader()
            MsgBox("Stock Has Been Released Successfully." + "  " + "For Consignor ID: " + ComboBox2.Text + vbNewLine + "Thank You.")
            ...
            If bimbi = DialogResult.Yes Then
                ...
                outgoing_dispatch_Load(e, e) 'Load everything in your form load event again hahaha in tagalog ulit
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        ...
        Dim kamotengfrognabakal As DialogResult = MsgBox("Are You Sure You Want to Do A Reset? All Changes Will Be Revert When That Happened.", 4 + 32, )
        If kamotengfrognabakal = DialogResult.Yes Then
