...
Public Class Delete_Access_for_Receiving_admin_function
    ...
    Private Sub Delete_Access_for_Receiving_admin_function_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
    ...
    Private Sub Delete_Access_for_Receiving_admin_function_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub ComboBox1_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ComboBox1.SelectedIndexChanged
        ...
        Try
            ...
            con.Open()
            Dim query As String
            query = "select * from `receiving access` where `emp_no` ='" + ComboBox1.Text + "'"
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        con.Open()
        Dim query As String
        query = "DELETE FROM `receiving access` WHERE `emp_no`='" & ComboBox1.Text & "'"
        cmd = New MySqlCommand(query, con)
        cmd.CommandTimeout = 240  'for time out errors
        rd = cmd.ExecuteReader()
        MsgBox(" Receiving Access has Been Terminated ")
        con.Close()
